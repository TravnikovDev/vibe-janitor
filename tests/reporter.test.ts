...
describe('Reporter Module', () => {
  ...
  beforeEach(async () => {
    ...
    mockCleaningResult = {
      unusedImports: [
        { file: '/path/to/file1.ts', imports: ['import1', 'import2'] }
      ],
      unusedVariables: [
        { file: '/path/to/file2.ts', variables: ['var1', 'var2'] }
      ],
      unusedFunctions: [
        { file: '/path/to/file3.ts', functions: ['func1', 'func2'] }
      ],
    ...
    mockStyleCleaningResult = {
      analyzedFiles: 5,
      styleDefinitions: [
        { file: '/path/to/style1.css', selectors: [] }
      ],
      unusedSelectors: [
        { file: '/path/to/style1.css', selectors: ['.unused1', '.unused2'] }
      ],
  ...
  test('should generate console summary', () => {
    ...
    reporter.generateConsoleSummary(mockCleaningResult, mockAssetSweepResult, true, mockStyleCleaningResult);
